...
Plan:  I will be building a glasses-computer utilizing the tapping of the thumb to different fingers as a keyboard. This will use transparent OLED technology to display information from a raspberry pi. This is my first time working with displays, transistors and keyboard technology; I hope all goes well!
...
Tools: I will utilize a soldering iron, a 3d printer, and glue<p>
