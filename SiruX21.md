...
| PCB Printing if we do it| https://jlcpcb.com/ | N/A|
| Parts if build a PCB| https://www.newark.com/nxp/ptn3460ibs-f2mp/edp-to-lvds-bridge-40-to-85deg/dp/85AC2140?CMP=AFC-OP | N/A|
| Raspberry Pi |Owned|Owned|
| Laptop Panel #1 |Owned (will scavenge from other laptop)|Owned|
| Laptop Panel #2 |Owned (will scavenge from another laptopt)|Owned|
